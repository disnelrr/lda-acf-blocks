  ...
  foreach ($images as $image) : ?>
    <a href="<?php echo $image['link']; ?>">
      <div class="image-container mb-4 position-relative">
        <div class="position-absolute w-100" style="top: 0; left: 0; background: black">
          <img class="w-100" src="<?php echo $image['image']; ?>" alt="" loading="lazy" style="opacity: 0.5" />
          <div class="text-white p-5 position-absolute" style="bottom: 0">
            <div class="font-weight-bold text-uppercase" style="font-size: 2rem;">
              <?php echo $image['name']; ?>
            </div>
            <?php echo $image['size'] . ' sq. ft'; ?>
          </div>
        </div>  
